...
mixin _$ApprovalDocument {
 ...
 String get id; String get title; String get drafter; String get department; String get form; String get status; String get draftedAt; String get dueDate; int get progress; String get documentNo; String get effectiveDate; String get cooperationDepartment; String get agreement; String get content; bool get urgent; bool get receivedRequest; bool get canCancel; bool get canReuse; bool get canEdit; List<String> get receivers; List<String> get references; List<String> get viewers; List<String> get publicReceivers; List<String> get linkedDocuments; List<ApprovalAttachment> get attachments; String get documentLayout; Map<String, String> get formFields; List<Map<String, String>> get lineItems; List<ApprovalStep> get steps; List<ApprovalHistory> get histories;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,drafter,department,form,status,draftedAt,dueDate,progress,documentNo,effectiveDate,cooperationDepartment,agreement,content,urgent,receivedRequest,canCancel,canReuse,canEdit,const DeepCollectionEquality().hash(receivers),const DeepCollectionEquality().hash(references),const DeepCollectionEquality().hash(viewers),const DeepCollectionEquality().hash(publicReceivers),const DeepCollectionEquality().hash(linkedDocuments),const DeepCollectionEquality().hash(attachments),documentLayout,const DeepCollectionEquality().hash(formFields),const DeepCollectionEquality().hash(lineItems),const DeepCollectionEquality().hash(steps),const DeepCollectionEquality().hash(histories)]);

@override
String toString() {
  return 'ApprovalDocument(id: $id, title: $title, drafter: $drafter, department: $department, form: $form, status: $status, draftedAt: $draftedAt, dueDate: $dueDate, progress: $progress, documentNo: $documentNo, effectiveDate: $effectiveDate, cooperationDepartment: $cooperationDepartment, agreement: $agreement, content: $content, urgent: $urgent, receivedRequest: $receivedRequest, canCancel: $canCancel, canReuse: $canReuse, canEdit: $canEdit, receivers: $receivers, references: $references, viewers: $viewers, publicReceivers: $publicReceivers, linkedDocuments: $linkedDocuments, attachments: $attachments, documentLayout: $documentLayout, formFields: $formFields, lineItems: $lineItems, steps: $steps, histories: $histories)';
}
...
@useResult
$Res call({
 String id, String title, String drafter, String department, String form, String status, String draftedAt, String dueDate, int progress, String documentNo, String effectiveDate, String cooperationDepartment, String agreement, String content, bool urgent, bool receivedRequest, bool canCancel, bool canReuse, bool canEdit, List<String> receivers, List<String> references, List<String> viewers, List<String> publicReceivers, List<String> linkedDocuments, List<ApprovalAttachment> attachments, String documentLayout, Map<String, String> formFields, List<Map<String, String>> lineItems, List<ApprovalStep> steps, List<ApprovalHistory> histories
});
...
as List<ApprovalAttachment>,documentLayout: null == documentLayout ? _self.documentLayout : documentLayout // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String drafter,  String department,  String form,  String status,  String draftedAt,  String dueDate,  int progress,  String documentNo,  String effectiveDate,  String cooperationDepartment,  String agreement,  String content,  bool urgent,  bool receivedRequest,  bool canCancel,  bool canReuse,  bool canEdit,  List<String> receivers,  List<String> references,  List<String> viewers,  List<String> publicReceivers,  List<String> linkedDocuments,  List<ApprovalAttachment> attachments,  String documentLayout,  Map<String, String> formFields,  List<Map<String, String>> lineItems,  List<ApprovalStep> steps,  List<ApprovalHistory> histories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApprovalDocument() when $default != null:
return $default(_that.id,_that.title,_that.drafter,_that.department,_that.form,_that.status,_that.draftedAt,_that.dueDate,_that.progress,_that.documentNo,_that.effectiveDate,_that.cooperationDepartment,_that.agreement,_that.content,_that.urgent,_that.receivedRequest,_that.canCancel,_that.canReuse,_that.canEdit,_that.receivers,_that.references,_that.viewers,_that.publicReceivers,_that.linkedDocuments,_that.attachments,_that.documentLayout,_that.formFields,_that.lineItems,_that.steps,_that.histories);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String drafter,  String department,  String form,  String status,  String draftedAt,  String dueDate,  int progress,  String documentNo,  String effectiveDate,  String cooperationDepartment,  String agreement,  String content,  bool urgent,  bool receivedRequest,  bool canCancel,  bool canReuse,  bool canEdit,  List<String> receivers,  List<String> references,  List<String> viewers,  List<String> publicReceivers,  List<String> linkedDocuments,  List<ApprovalAttachment> attachments,  String documentLayout,  Map<String, String> formFields,  List<Map<String, String>> lineItems,  List<ApprovalStep> steps,  List<ApprovalHistory> histories)  $default,) {final _that = this;
switch (_that) {
case _ApprovalDocument():
return $default(_that.id,_that.title,_that.drafter,_that.department,_that.form,_that.status,_that.draftedAt,_that.dueDate,_that.progress,_that.documentNo,_that.effectiveDate,_that.cooperationDepartment,_that.agreement,_that.content,_that.urgent,_that.receivedRequest,_that.canCancel,_that.canReuse,_that.canEdit,_that.receivers,_that.references,_that.viewers,_that.publicReceivers,_that.linkedDocuments,_that.attachments,_that.documentLayout,_that.formFields,_that.lineItems,_that.steps,_that.histories);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey() List<ApprovalAttachment> get attachments {
